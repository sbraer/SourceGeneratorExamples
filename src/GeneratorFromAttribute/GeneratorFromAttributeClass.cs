    ...
    {
        {
            ...
            string source = $$"""
                ...
                internal sealed class GenerateSetPropertyAttribute<T>(GeneratorNotTypeRecognized generatorNotTypeRecognized = GeneratorNotTypeRecognized.CompilationError) : global::System.Attribute where T : class
                {
                    public GeneratorNotTypeRecognized GeneratorNotTypeRecognized { get; } = generatorNotTypeRecognized;
                }

                internal enum GeneratorNotTypeRecognized : int { Skip = 0, ThrowException = 1, CompilationError = 2 }
                """;
...

        {
            ...
            var fileName = "GeneratorFromAttributeExample.HelperFunction.g.cs";
            context.AddSource(fileName, source);
        }
    }
